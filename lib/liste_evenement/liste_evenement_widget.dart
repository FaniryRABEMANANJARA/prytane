...
class _ListeEvenementWidgetState extends State<ListeEvenementWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EvenementsRecord>>(
      stream: queryEvenementsRecord(
        queryBuilder: (evenementsRecord) =>
            evenementsRecord.orderBy('date_debut', descending: true),
      ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!valueOrDefault<bool>(
                          ...
                          Builder(
                            builder: (context) {
                              final serachEvenement =
                                  listeEvenementEvenementsRecordList.toList();
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(serachEvenement.length,
                                    (serachEvenementIndex) {
                                  final serachEvenementItem =
                                      serachEvenement[serachEvenementIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 5.0, 0.0, 5.0),
                                    child: Material(
