...
import 'ajoutpublication_admin_g_model.dart';
export 'ajoutpublication_admin_g_model.dart';

class AjoutpublicationAdminGWidget extends StatefulWidget {
  const AjoutpublicationAdminGWidget({super.key});

  @override
  State<AjoutpublicationAdminGWidget> createState() =>
      _AjoutpublicationAdminGWidgetState();
}

class _AjoutpublicationAdminGWidgetState
    extends State<AjoutpublicationAdminGWidget> {
  late AjoutpublicationAdminGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutpublicationAdminGModel());
