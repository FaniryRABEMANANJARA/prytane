  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MembresGroupeRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MembresGroupeRecord> adhesionGroupMembresGroupeRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final adhesionGroupMembresGroupeRecord =
            adhesionGroupMembresGroupeRecordList.isNotEmpty
                ? adhesionGroupMembresGroupeRecordList.first
                : null;
                        ...
                        child: Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                await MembrevalidateRecord.collection
                                    .doc()
                                    .set(createMembrevalidateRecordData(
                                      fullname:
                                      ...
                                      idGroup: adhesionGroupMembresGroupeRecord
                                          ?.idGroup,
                                      sexe: _model.choiceChipsValue,
                                      type: adhesionGroupMembresGroupeRecord
                                          ?.type,
                                      image: adhesionGroupMembresGroupeRecord
                                          ?.image,
                                    ));
                                await adhesionGroupMembresGroupeRecord!
                                    .reference
                                    .delete();
