...
export 'ajout_group_model.dart';

class AjoutGroupWidget extends StatefulWidget {
  const AjoutGroupWidget({super.key});
...
class _AjoutGroupWidgetState extends State<AjoutGroupWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutGroupModel());
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Saisir le nom du groupe...',
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Saisir la description du groupe...',
                    hintStyle: FlutterFlowTheme.of(context).bodyLarge.override(
                          fontFamily:
                              FlutterFlowTheme.of(context).bodyLargeFamily,
                          letterSpacing: 0.0,
                              ...
                              children: [
                                StreamBuilder<List<UsersRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<UsersRecord> membresUsersRecordList =
                                        snapshot.data!;
                                    return FlutterFlowDropDown<String>(
                                      multiSelectController:
                                          _model.membresValueController ??=
                                      ...
                                      hintText: membresUsersRecordList.length
                                          .toString(),
                                      icon: Icon(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      multiSelectController: _model
                                              .administrateursValueController ??=
                                          FormFieldController<List<String>>(
                                              _model.administrateursValue ??=
                                                  List<String>.from(
                                        administrateursUsersRecordList
                                                .map((e) => e.nom)
                                                .toList() ??
                                      ...
                                      options: administrateursUsersRecordList
                                          .map((e) => e.nom)
                                          .toList(),
                                      width: 300.0,
                                      height: 56.0,
                                      ...
                                      hintText: administrateursUsersRecordList
                                          .length
                                          .toString(),
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await GroupesRecord.collection.doc().set({
                      ...
                      ...mapToFirestore(
                        {
                          ...
                          'administrateurs': [currentUserReference],
                        },
                      ),
                    });
