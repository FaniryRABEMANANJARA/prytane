...
class _ParametresWidgetState extends State<ParametresWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PublicationsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PublicationsRecord> containerPublicationsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final containerPublicationsRecord =
            containerPublicationsRecordList.isNotEmpty
                ? containerPublicationsRecordList.first
                : null;
        return Container(
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'Modifierpublication',
                                  queryParameters: {
                                    'modifierPost': serializeParam(
                                      containerPublicationsRecord?.reference,
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                await containerPublicationsRecord!.reference
                                    .delete();
