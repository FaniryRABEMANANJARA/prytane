...
class SondageWidget extends StatefulWidget {
  const SondageWidget({
    super.key,
    required this.detailSondage,
  });

  final SondageRecord? detailSondage;
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            formatNumber(
                                                                              listViewSondageRecord.opt1list.length,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          formatNumber(
                                                                            listViewSondageRecord.opt2list.length,
                                                                            formatType:
                                                                                FormatType.decimal,
                                                                            decimalType:
