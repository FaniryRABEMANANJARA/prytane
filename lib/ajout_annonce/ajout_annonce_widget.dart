...
import 'ajout_annonce_model.dart';
export 'ajout_annonce_model.dart';

class AjoutAnnonceWidget extends StatefulWidget {
  const AjoutAnnonceWidget({super.key});

  @override
  State<AjoutAnnonceWidget> createState() => _AjoutAnnonceWidgetState();
}

class _AjoutAnnonceWidgetState extends State<AjoutAnnonceWidget>
    with TickerProviderStateMixin {
  late AjoutAnnonceModel _model;
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 10.0, 10.0, 0.0),
                    child: SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                              ...
                              onPressed: () async {
                                await AnnoncesRecord.collection
                                    ...
                                    .set(createAnnoncesRecordData(
                                      ...
                                      localisation: _model
                                          .localisationTextController.text,
